        ...
        <div>
            <table style="width: 100%; height: 358px; padding: 5px" border="0">
                ...
                <td style="vertical-align: top">
                    ...
                    <form method="GET" action="http://localhost:8084/NewTech/Login" style="text-align: center; font-family: 'Monotype Corsiva'; font-size: 35px; font-weight: bold; ">
                        Hello! welcome to NewTech, please login.<br /><br />
                        <table style="width: 200px; height: 200px; padding: 5px" border="0" align="center">
                            <tr style="text-align: left;  font-family: 'Monotype Corsiva'; font-size: 25px; font-weight: bold; ">Some of new books are follow</tr>
                            <tr>
                                <td style="text-align: center; vertical-align: middle; font-family: 'Times New Roman'; font-size: 25px;  "><img src="BookImg1.gif" alt="book1" height="200px" width="130px"><br />book1</td>
                                <td style="text-align: center; vertical-align: middle; font-family: 'Times New Roman'; font-size: 25px; "><img src="BookImg2.gif" alt="book2" height="200px" width="130px"><br />book2</td>
                                <td style="text-align: center; vertical-align: middle; font-family: 'Times New Roman'; font-size: 25px; "><img src="BookImg3.gif" alt="book3" height="200px" width="130px"><br />book3</td>
                                <td style="text-align: center; vertical-align: middle; font-family: 'Times New Roman'; font-size: 25px;  "><img src="BookImg4.gif" alt="book4" height="200px" width="130px"><br />book4</td>
                                <td style="text-align: center; vertical-align: middle; font-family: 'Times New Roman'; font-size: 25px;  "><img src="BookImg5.gif" alt="book5" height="200px" width="130px"><br />book5</td>
                            </tr>
