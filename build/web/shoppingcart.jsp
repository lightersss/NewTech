                ...
                <tr>
                   ...
                   <td style="vertical-align: top; background-color: #106e0c; color: #FFFFFF; width: 100px;">
                    ...
                    <td style="vertical-align: top">
                        ...
                        <table tyle="text-align: center; font-family: 'Monotype Corsiva'; font-size: 25px; font-weight: bold; ">
                         
                      
                    <c:forEach items="${cart}" var="m">
                     
                         <tr><td>BOOK NAME<c:out value="${m.value.bookname}"/></td></tr>
                         <tr><td>ISBN<c:out value="${m.value.booisbn}"/></td></tr>
                         <tr><td>PRESS<c:out value="${m.value.press}"/></td></tr>
                         <tr><td>QUANTITY<c:out value="${m.value.stock}"/></td></tr>
                         <tr><td>Unit Price<c:out value="${m.value.price}"/></td></tr>
                      
                         <tr><td><a href="http://localhost:8080/NewTech/add?action=add&isbn=${m.value.booisbn}"> +1</a> </td></tr>
                          <tr><td><a href="http://localhost:8080/NewTech/add?action=remove&isbn=${m.value.booisbn}"> -1</a> </td></tr>
                        
                    </c:forEach>
                          
                            <form method="post" action="http://localhost:8080/NewTech/order">
