                    ...
                    <td style="vertical-align: top; background-color: #106e0c; color: #FFFFFF; width: 100px;">
                        ...
                        <ul>
                            <c:if test="${sessionScope.user==null}">
                                ...
                                <li><a href="http://localhost:8084/NewTech/SearchBill" Font-Underline="False" ForeColor="#FFFFFF" Style="font-size: 9pt; font-family: 'Times New Roman'" Width="89px">bill</a>
                                </c:if>
                                <br />  
                                <br />
                    ...
                    <td style="vertical-align: top">
                        ...
                        <table >
                            ...
                            <c:forEach items="${cart}" var="m">
                                <tr><td>book name<c:out value="${m.value.bookname}"/></td>
                                    <td>isbn<c:out value="${m.value.booisbn}"/></td>
                                    <td>press<c:out value="${m.value.press}"/></td>
                                    <td>quantity<c:out value="${m.value.stock}"/></td>
                                    <td>Unit Price<c:out value="${m.value.price}"/></td>                       
                                </c:forEach>
                            <form method="post" action="http://localhost:8080/NewTech/payment">
                                <tr><td>order number<input type="text" name="pincode"  readonly="true" value="${requestScope.ordernum}"/></td></tr>
                                <tr><td>Total price<input type="text" name="price"  readonly="true" value="${requestScope.price}"/></td></tr>
                                <tr><td>card number<input type="text" name="cardnumber" /></td></tr>
                                <tr><td>card type<input type="text" name="cardtype"/></td></tr>
