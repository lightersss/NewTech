                   ...
                   <td style="vertical-align: top; background-color: #106e0c; color: #FFFFFF; width: 100px;">
                    ...
                    <td style="vertical-align: top">
                        ...
                        <table border="1" cellspacing="0" width="600px;">
                            <tr> <td> book name</td><td>press</td><td>ISBN</td><td>choose</td></tr>
                      
                  <form method="POST" action="http://localhost:8080/NewTech/Shoppingcart">
                            <c:forEach var="book"  varStatus="status" items="${books}">
                                <tr> <td>    ${book.bookname}</td>
                                      <td>${book.press}</td>
                                      <td>${book.booisbn}</td>
                                    <td><input type="checkbox" name="book" value="${book.booisbn}" /></td></tr>
                    </c:forEach>
                              
                               <td><input type="submit" value="to the cart"/>
                            </form>
